            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.profileCard}>
                    ...
                    <div className={styles.profileInfo}>
                        ...
                        <p className={styles.temperature}>
                            당근 온도: <span style={{color:'#ff8a3d', fontWeight:'bold'}}>{userInfo.mannerTemp}°C</span>
                        </p>
                ...
                <h3 className={styles.sectionTitle}>나의 판매 목록 ({userInfo.myItems.length})</h3>
                    ...
                    {userInfo.myItems.length > 0 ? (
                        userInfo.myItems.map((item) => (
                            ...
                            >
                                ...
                                <img
                                    src={item.thumbnailUrl || "https://placehold.co/150x150?text=No+Image"}
                                ...
                                <div className={styles.itemInfo}>
                                    ...
                                    <p style={{fontSize:'12px', color:'#888', marginTop:'5px'}}>
                                        {item.region} · {item.status === 'SOLD' ? '판매완료' : '판매중'}
                                    </p>
                                </div>
                            </div>
                        ))
                    ) : (
                        <p style={{color:'#999', padding:'20px'}}>판매 내역이 없어요.</p>
                    )}
                </div>
            </div>
        </>
